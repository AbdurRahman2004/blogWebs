...
app.get("/edit/:id", (req, res) => {
    ...
    res.render("edit.ejs", { title : post.title, content: post.content, index1 : index});
});
...
app.post("/update/:id", (req,res)=>{
    ...
    editPost(title1,content1,index);
    res.redirect("/");
...
app.listen(port,()=>{
    ...
    console.log(`Your port is succesfully running in port ${port}`);
})
